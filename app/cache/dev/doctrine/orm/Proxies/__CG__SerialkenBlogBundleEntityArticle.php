...
namespace Proxies\__CG__\Serialken\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Article extends \Serialken\BlogBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'date', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'titre', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'auteur', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'contenu', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'publication', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'categories', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'commentaires', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'dateEdition', '' . "\0" . 'Serialken\\BlogBundle\\Entity\\Article' . "\0" . 'slug');
        }
    ...
    public function preUpdateDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'preUpdateDate', array());

        return parent::preUpdateDate();
    }
    ...
    public function setDateEdition($date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateEdition', array($date));

        return parent::setDateEdition($date);
    }
